...
@interface FDKeyChainStore : NSObject
...
+ (FDKeyChainStore *)keyChainStoreWithService:(nullable NSString *)service;
+ (FDKeyChainStore *)keyChainStoreWithService:(nullable NSString *)service accessGroup:(nullable NSString *)accessGroup;
...
+ (nullable NSArray *)allKeysWithItemClass:(FDKeyChainStoreItemClass)itemClass;
...
@interface FDKeyChainStore (ErrorHandling)
...
@interface FDKeyChainStore (ForwardCompatibility)
...
@interface FDKeyChainStore (Deprecation)
