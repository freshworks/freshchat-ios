...
@interface FDKeyChainStore ()

@end

@implementation FDKeyChainStore
...
+ (FDKeyChainStore *)keyChainStore
{
    return [[self alloc] initWithService:nil accessGroup:nil];
}

+ (FDKeyChainStore *)keyChainStoreWithService:(NSString *)service
{
    return [[self alloc] initWithService:service accessGroup:nil];
}

+ (FDKeyChainStore *)keyChainStoreWithService:(NSString *)service accessGroup:(NSString *)accessGroup
{
...
+ (FDKeyChainStore *)keyChainStoreWithServer:(NSURL *)server protocolType:(FDKeyChainStoreProtocolType)protocolType
{
    return [[self alloc] initWithServer:server protocolType:protocolType authenticationType:FDKeyChainStoreAuthenticationTypeDefault];
}

+ (FDKeyChainStore *)keyChainStoreWithServer:(NSURL *)server protocolType:(FDKeyChainStoreProtocolType)protocolType authenticationType:(FDKeyChainStoreAuthenticationType)authenticationType
{
...
- (instancetype)initWithService:(NSString *)service accessGroup:(NSString *)accessGroup
{
    self = [super init];
    if (self) {
        _itemClass = FDKeyChainStoreItemClassGenericPassword;
...
{
    return [self initWithServer:server protocolType:protocolType authenticationType:FDKeyChainStoreAuthenticationTypeDefault];
}
...
- (instancetype)initWithServer:(NSURL *)server protocolType:(FDKeyChainStoreProtocolType)protocolType authenticationType:(FDKeyChainStoreAuthenticationType)authenticationType
{
    self = [super init];
    if (self) {
        _itemClass = FDKeyChainStoreItemClassInternetPassword;
...
+ (NSString *)stringForKey:(NSString *)key service:(NSString *)service accessGroup:(NSString *)accessGroup error:(NSError *__autoreleasing *)error
{
    ...
    FDKeyChainStore *keychain = [FDKeyChainStore keyChainStoreWithService:service accessGroup:accessGroup];
...
+ (NSArray UIC_KEY_TYPE *)allKeysWithItemClass:(FDKeyChainStoreItemClass)itemClass
{
    CFTypeRef itemClassObject = kSecClassGenericPassword;
    if (itemClass == FDKeyChainStoreItemClassGenericPassword) {
        itemClassObject = kSecClassGenericPassword;
    } else if (itemClass == FDKeyChainStoreItemClassInternetPassword) {
...
+ (NSArray *)allItemsWithItemClass:(FDKeyChainStoreItemClass)itemClass
{
    CFTypeRef itemClassObject = kSecClassGenericPassword;
    if (itemClass == FDKeyChainStoreItemClassGenericPassword) {
        itemClassObject = kSecClassGenericPassword;
...
{
    switch (_itemClass) {
        case FDKeyChainStoreItemClassGenericPassword:
            return kSecClassGenericPassword;
        case FDKeyChainStoreItemClassInternetPassword:
...
- (CFTypeRef)protocolTypeObject
{
    switch (_protocolType) {
        case FDKeyChainStoreProtocolTypeFTP:
            return kSecAttrProtocolFTP;
        case FDKeyChainStoreProtocolTypeFTPAccount:
            return kSecAttrProtocolFTPAccount;
        case FDKeyChainStoreProtocolTypeHTTP:
            return kSecAttrProtocolHTTP;
        case FDKeyChainStoreProtocolTypeIRC:
            return kSecAttrProtocolIRC;
        case FDKeyChainStoreProtocolTypeNNTP:
            return kSecAttrProtocolNNTP;
        case FDKeyChainStoreProtocolTypePOP3:
            return kSecAttrProtocolPOP3;
        case FDKeyChainStoreProtocolTypeSMTP:
            return kSecAttrProtocolSMTP;
        case FDKeyChainStoreProtocolTypeSOCKS:
            return kSecAttrProtocolSOCKS;
        case FDKeyChainStoreProtocolTypeIMAP:
            return kSecAttrProtocolIMAP;
        case FDKeyChainStoreProtocolTypeLDAP:
            return kSecAttrProtocolLDAP;
        case FDKeyChainStoreProtocolTypeAppleTalk:
            return kSecAttrProtocolAppleTalk;
        case FDKeyChainStoreProtocolTypeAFP:
            return kSecAttrProtocolAFP;
        case FDKeyChainStoreProtocolTypeTelnet:
            return kSecAttrProtocolTelnet;
        case FDKeyChainStoreProtocolTypeSSH:
            return kSecAttrProtocolSSH;
        case FDKeyChainStoreProtocolTypeFTPS:
            return kSecAttrProtocolFTPS;
        case FDKeyChainStoreProtocolTypeHTTPS:
            return kSecAttrProtocolHTTPS;
        case FDKeyChainStoreProtocolTypeHTTPProxy:
            return kSecAttrProtocolHTTPProxy;
        case FDKeyChainStoreProtocolTypeHTTPSProxy:
            return kSecAttrProtocolHTTPSProxy;
        case FDKeyChainStoreProtocolTypeFTPProxy:
            return kSecAttrProtocolFTPProxy;
        case FDKeyChainStoreProtocolTypeSMB:
            return kSecAttrProtocolSMB;
        case FDKeyChainStoreProtocolTypeRTSP:
            return kSecAttrProtocolRTSP;
        case FDKeyChainStoreProtocolTypeRTSPProxy:
            return kSecAttrProtocolRTSPProxy;
        case FDKeyChainStoreProtocolTypeDAAP:
            return kSecAttrProtocolDAAP;
        case FDKeyChainStoreProtocolTypeEPPC:
            return kSecAttrProtocolEPPC;
        case FDKeyChainStoreProtocolTypeNNTPS:
            return kSecAttrProtocolNNTPS;
        case FDKeyChainStoreProtocolTypeLDAPS:
            return kSecAttrProtocolLDAPS;
        case FDKeyChainStoreProtocolTypeTelnetS:
            return kSecAttrProtocolTelnetS;
        case FDKeyChainStoreProtocolTypeIRCS:
            return kSecAttrProtocolIRCS;
        case FDKeyChainStoreProtocolTypePOP3S:
...
- (CFTypeRef)authenticationTypeObject
{
    switch (_authenticationType) {
        case FDKeyChainStoreAuthenticationTypeNTLM:
            return kSecAttrAuthenticationTypeNTLM;
        case FDKeyChainStoreAuthenticationTypeMSN:
            return kSecAttrAuthenticationTypeMSN;
        case FDKeyChainStoreAuthenticationTypeDPA:
            return kSecAttrAuthenticationTypeDPA;
        case FDKeyChainStoreAuthenticationTypeRPA:
            return kSecAttrAuthenticationTypeRPA;
        case FDKeyChainStoreAuthenticationTypeHTTPBasic:
            return kSecAttrAuthenticationTypeHTTPBasic;
        case FDKeyChainStoreAuthenticationTypeHTTPDigest:
            return kSecAttrAuthenticationTypeHTTPDigest;
        case FDKeyChainStoreAuthenticationTypeHTMLForm:
            return kSecAttrAuthenticationTypeHTMLForm;
        case FDKeyChainStoreAuthenticationTypeDefault:
...
- (CFTypeRef)accessibilityObject
{
    switch (_accessibility) {
        case FDKeyChainStoreAccessibilityWhenUnlocked:
            return kSecAttrAccessibleWhenUnlocked;
        case FDKeyChainStoreAccessibilityAfterFirstUnlock:
            return kSecAttrAccessibleAfterFirstUnlock;
        case FDKeyChainStoreAccessibilityAlways:
            return kSecAttrAccessibleAlways;
        case FDKeyChainStoreAccessibilityWhenPasscodeSetThisDeviceOnly:
            return kSecAttrAccessibleWhenPasscodeSetThisDeviceOnly;
        case FDKeyChainStoreAccessibilityWhenUnlockedThisDeviceOnly:
            return kSecAttrAccessibleWhenUnlockedThisDeviceOnly;
        case FDKeyChainStoreAccessibilityAfterFirstUnlockThisDeviceOnly:
            return kSecAttrAccessibleAfterFirstUnlockThisDeviceOnly;
        case FDKeyChainStoreAccessibilityAlwaysThisDeviceOnly:
