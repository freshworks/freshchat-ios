...
@interface FCKeyChainStore ()

@end

@implementation FCKeyChainStore
...
+ (FCKeyChainStore *)keyChainStoreWithService:(NSString *)service
{
    return [[self alloc] initWithService:service accessGroup:nil];
}

+ (FCKeyChainStore *)keyChainStoreWithService:(NSString *)service accessGroup:(NSString *)accessGroup
{
...
+ (NSString *)stringForKey:(NSString *)key service:(NSString *)service accessGroup:(NSString *)accessGroup error:(NSError *__autoreleasing *)error
{
    ...
    FCKeyChainStore *keychain = [FCKeyChainStore keyChainStoreWithService:service accessGroup:accessGroup];
