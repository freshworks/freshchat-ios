...
-(id)initWithDelegate:(id <FDMarginalViewDelegate>)delegate{
    ...
    if (self) {
        ...
        [FCAutolayoutHelper centerY:self.contactUsImgView onView:self];
        
        [FCAutolayoutHelper center:self.actionLabel onView:self];
