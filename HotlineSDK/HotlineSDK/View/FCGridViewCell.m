...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        [FCAutolayoutHelper centerX:self.imageView onView:self.contentView];
        [FCAutolayoutHelper centerY:self.imageView onView:self.contentView M:0.8 C:0];
