...
#define HOTLINE_DEFAULTS_OLD_DEVICE_ID @"hotline_defaults_old_device_id"
...
#define HOTLINE_DEFAULTS_SOLUTIONS_LAST_UPDATED_INTERVAL_TIME @"hotline_defaults_solutions_last_updated_itv_time_v2"
