...
#define HOTLINE_DEFAULTS_SOLUTIONS_LAST_UPDATED_SERVER_TIME @"hotline_defaults_solutions_last_updated_svr_time"
#define HOTLINE_DEFAULTS_SOLUTIONS_LAST_UPDATED_INTERVAL_TIME @"hotline_defaults_solutions_last_updated_itv_time"
#define HOTLINE_DEFAULTS_CHANNELS_LAST_UPDATED_SERVER_TIME @"hotline_defaults_channels_last_updated_svr_time"
#define HOTLINE_DEFAULTS_CHANNELS_LAST_UPDATED_INTERVAL_TIME @"hotline_defaults_channels_last_updated_itv_time"
...
#define HOTLINE_DEFAULTS_DAU_LAST_UPDATED_INTERVAL_TIME @"hotline_defaults_dau_last_updated_itv_time"
