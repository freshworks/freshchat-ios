...
+(void)clearUserDefaults {
    NSUserDefaults * defaults = [NSUserDefaults standardUserDefaults];
    NSArray * defaultsKey = @[FC_SOLUTIONS_LAST_RECEIVED_LOCALE, HOTLINE_DEFAULTS_CONTENT_LOCALE, FC_CHANNELS_LAST_RECEIVED_LOCALE, FRESHCHAT_DEFAULTS_SESSION_UPDATED_TIME,HOTLINE_DEFAULTS_IS_MESSAGE_SENT,FRESHCHAT_DEFAULTS_SESSION_UPDATED_TIME];
