...
+(void)clearUserDefaults {
    NSUserDefaults * defaults = [NSUserDefaults standardUserDefaults];
    NSArray * defaultsKey = @[HOTLINE_DEFAULTS_FAQ_LOCALEID, HOTLINE_DEFAULTS_CONTENT_LOCALE, HOTLINE_DEFAULTS_CONV_LOCALEID, FRESHCHAT_DEFAULTS_SESSION_UPDATED_TIME,HOTLINE_DEFAULTS_IS_MESSAGE_SENT,FRESHCHAT_DEFAULTS_SESSION_UPDATED_TIME];
