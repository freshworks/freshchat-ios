...
-(instancetype)initWithDelegate:(id <FDInputToolbarViewDelegate>)delegate{
    ...
    if (self) {
        ...
        UIImage *attachmentImage = [self.theme getImageWithKey:HOTLINE_ATTACH_ICON];
        ...
        UIImage *micImage = [[HLTheme sharedInstance]getImageWithKey:HOTLINE_INPUT_TOOLBAR_MIC];
