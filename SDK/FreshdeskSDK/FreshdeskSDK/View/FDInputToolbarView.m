...
-(instancetype)initWithDelegate:(id <FDInputToolbarViewDelegate, FDGrowingTextViewDelegate>)delegate{
    ...
    if (self) {
        ...
        textView.placeholder = FDLocalizedString(@"Message Placeholder Text" );
        [textView setTranslatesAutoresizingMaskIntoConstraints:NO];
        [textView.internalTextView setTranslatesAutoresizingMaskIntoConstraints:NO];
        
        UIImage *innerTextViewImage = [self.theme getThemedImageFromMHBundleWithName:MOBIHELP_IMAGE_MESSAGE_BAR_INNER_TEXT_VIEW];
        UIImage *outerTextViewImage = [self.theme getThemedImageFromMHBundleWithName:MOBIHELP_IMAGE_MESSAGE_BAR_OUTER_TEXT_VIEW];
        ...
        [attachButton setImage:attachmentPinImage forState:UIControlStateNormal];
        ...
        [sendButton setTitle:FDLocalizedString(@"Send Button Text" ) forState:UIControlStateNormal];
