...
//  FreshdeskSDK
//
//  Created by Suman Raj Venkatesan on 26/10/12.
//  Copyright (c) 2012 Freshdesk. All rights reserved.
//
...
//Localization
#define FDLocalizedString(name) NSLocalizedStringFromTable(name, @"MHLocalizable", nil)
